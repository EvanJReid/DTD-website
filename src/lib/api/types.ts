...
export interface Document {
  ...
  downloads: number;
  folderId?: string;
  /** OCI Object Storage key — used to build the download URL */
  objectName?: string;
  /** Set by backend from session or request; used for contribution leaderboard */
  uploadedBy?: string;
}
...
export interface DatabaseAPI {
  ...
  addDocument(doc: Omit<Document, 'id' | 'downloads'> & { uploadedBy?: string }): Promise<Document>;
