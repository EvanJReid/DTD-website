...
interface UploadModalProps {
  isOpen: boolean;
  onClose: () => void;
  onUpload: (data: UploadData) => void | Promise<void>;
}
...
export function UploadModal({ isOpen, onClose, onUpload }: UploadModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (msg.includes("Sign in required") || msg.includes("401") || msg.includes("403")) {
        toast.error("Please sign in to upload documents. Use the Sign in button in the header.");
      } else {
